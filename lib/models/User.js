...
const UserSchema = new mongoose.Schema({
  ...
  mixingExpiry: { type: Date, default: null },
  mixingIsPermanent: { type: Boolean, default: false },
  mixingTrialClaimed: { type: Boolean, default: false },
  mixingIsTrialActive: { type: Boolean, default: false },
