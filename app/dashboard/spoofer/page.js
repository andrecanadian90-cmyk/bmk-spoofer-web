...
const translations = {
  en: {
    ...
    audioDetail1: 'Private Audio Mode (FREE) — Clone and hijack someone else\'s private audio asset to make it your own instantly',
  ...
  id: {
    ...
    audioDetail1: 'Mode Audio Privat (GRATIS) — Mengkloning dan merebut aset audio privat orang lain menjadi milik Anda sendiri secara instan',
