...
const translations = {
  id: {
    ...
    basicDesc: 'Batas 10x spoof per hari (semua tipe aset digabung) • Antrean Standard.',
  ...
  en: {
    ...
    basicDesc: 'Limit of 10x spoof per day (all asset types combined) • Standard Queue.',
